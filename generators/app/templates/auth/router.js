...
router.get('/login', function*() {
  yield this.render('login', {errors: this.flash('error'), csrf: this.csrf});
});
...
router.get('/signup', function*() {
  yield this.render('signup', {messages: this.flash(), csrf: this.csrf});
});
...
router.get('/forgot-password', function*() {
  yield this.render('forgotPassword', {messages: this.flash(), csrf: this.csrf});
});
